...
public class OrderPageControllerCRUD implements Initializable {

    @FXML
    public Label orderNumberLabel, totalProductsLabel;

    @FXML
    public TextField TextFieldColumnID, TextFieldProductID, TextFieldQuantity, TextFieldPrice;
    ...
    @FXML
    public TableColumn<OrderPageControllerCRUD, Integer> columnCID;
    ...
    IOrderCRUD orderCRUD = new OrderCRUD();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        // When pressing the submit button (named update in gui), the changes will be saved to the database
        Submit.setOnAction(event -> {
            orderCRUD.updateOrder(Integer.parseInt(String.valueOf(TextFieldColumnID.getText())), orderId, Integer.parseInt(String.valueOf(TextFieldProductID.getText())),
                    Integer.parseInt((String.valueOf(TextFieldQuantity.getText()))), Double.parseDouble(String.valueOf(TextFieldPrice.getText())));
            updateTableView();
        });
